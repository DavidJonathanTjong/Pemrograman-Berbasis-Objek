...
import framemenuutama.DashboardUtama;
...
public class Main extends javax.swing.JFrame {
    ...
    private void register() {
        ModelUser user = loginAndRegister.getUser();
        try {
            if (service.checkDuplicateUser(user.getNoPegawai())) {
                showMessage(Message.MessageType.ERROR, "Nomor pegawai sudah ada");
            }else if (service.checkDuplicateUsername(user.getUserName())) {
                showMessage(Message.MessageType.ERROR, "Username sudah ada");
            }else {
